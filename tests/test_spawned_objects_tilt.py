...
gazebo_objects_path = '/home/ffh/ffh_ws/gazebo-objects/objects_gazebo'

tilt_objects = []

shutil.rmtree('/home/ffh/grasp_data')
grasp_client = GraspClient(is_rec_sess=True, grasp_data_recording_path='/home/ffh/')
