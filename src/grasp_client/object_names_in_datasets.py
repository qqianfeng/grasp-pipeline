...
BIGBIRD_OBJECTS = [
    ...
    'blue_clover_baby_toy', 'bumblebee_albacore', 'canon_ack_e10_box', 'cheez_it_white_cheddar',
    ...
    'cup_noodles_chicken', 'cup_noodles_shrimp_picante', 'detergent', 'dove_beauty_cream_bar',
    'dove_go_fresh_burst', 'dove_pink', 'eating_right_for_healthy_living_apple',
    ...
    'haagen_dazs_butter_pecan', 'haagen_dazs_cookie_dough', 'hersheys_bar', 'hersheys_cocoa',
    ...
    'krylon_matte_finish', 'krylon_short_cuts', 'listerine_green', 'mahatma_rice',
    'mom_to_mom_butternut_squash_pear', 'mom_to_mom_sweet_potato_corn_apple',
    'motts_original_assorted_fruit', 'nature_valley_crunchy_oats_n_honey',
    'nature_valley_crunchy_variety_pack',
