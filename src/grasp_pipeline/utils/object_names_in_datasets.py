...
KIT_OBJECTS_DATA_GENERATED = [
    ...
    'NutellaGo', 'OrangeMarmelade', 'OrgFruitTea', 'Paprika', 
    'Patches', 'Peanuts2', 'Peanuts', 'Peas', 'PineappleSlices',
    'Pitcher', 'PotatoeDumplings', 'PotatoeStarch', 'PowderedSugarMill',
    'PowderedSugar', 'RedCup', 'Rice', 'SardinesCan',
    'SauceThickener', 'SmallGlass', 'SoftCakeOrange', 'Sprayflask', 'Sprudelflasche',
    'StrawberryPorridge', 
...
KIT_OBJECTS_DATA_FOR_POSTPROCESSING = ['InstantSauce', 'InstantSoup', 'InstantTomatoSoup', 'JamSugar',
                                       'Knaeckebrot', 'LivioClassicOil', 'MashedPotatoes', 'MelforBottle']
