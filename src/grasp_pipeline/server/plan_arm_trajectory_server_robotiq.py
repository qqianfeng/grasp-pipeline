...
class CartesianPoseMoveitPlanner():
    def __init__(self, hand = 'robotiq'):
        ...
        hand_link = "palm_link_robotiq" if hand == 'robotiq' else "palm_link_hithand"
        # hand_link = "panda_link8" if hand == 'robotiq' else "palm_link_hithand"
...
if __name__ == '__main__':
    # hand = "hithand"
    hand = "robotiq"
    planner = CartesianPoseMoveitPlanner(hand=hand)
